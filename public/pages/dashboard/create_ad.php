    ...
    <nav id="sidebar" class="sidebar-wrapper sidebar-dark">
        <div class="sidebar-content">
            <div class="sidebar-brand">
                <a href="create"><img src="../../assets/images/logo-light.png" alt=""></a>
            </div>
            ...
            <div class="layout-specing">
                ...
                <div class="container relative">
                    <div class="grid md:grid-cols-2 grid-cols-1 gap-6 mt-6">
                        ...
                        <div class="rounded-md shadow dark:shadow-gray-700 p-6 bg-white dark:bg-slate-900 h-fit">
                            <form class="/ads/create">
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12">
                                        <label for="title" class="font-medium">Title:</label>
                                        <input name="title" id="title" type="text" class="form-input mt-2" placeholder="Property Title :">
                                    </div>
                                    ...
                                    <div class="md:col-span-4 col-span-12">
                                        <label for="name" class="font-medium">Rooms:</label>
                                        <div class="form-icon relative mt-2">
